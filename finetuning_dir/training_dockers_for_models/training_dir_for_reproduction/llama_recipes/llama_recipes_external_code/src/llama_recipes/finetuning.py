...
def main(**kwargs):
    ...
    print("Anmol: The final config after all the updations is: ", train_config)

    # Set the seeds for reproducibility
    print("Train config seed is: ", train_config.seed)
    torch.cuda.manual_seed(train_config.seed)
    torch.manual_seed(train_config.seed)

    if train_config.enable_fsdp:
        print("Anmol: FSDP is enabled. Going to do distributed training.")
    ...
    if train_config.quantization:
        print("Anmol: preparing model for int8 training")
    ...
    print("Tokenizer has been loaded: ", tokenizer)
    if train_config.use_peft:
        peft_config = generate_peft_config(train_config, kwargs)
        print("PEFT config is: ", peft_config)
    ...
    print("Dataset config is: ", dataset_config)
    ...
    print("Anmol: Enable FSDP val is: ", train_config.enable_fsdp)
    ...
    print("Initializaing the optimizer and scheduler")
